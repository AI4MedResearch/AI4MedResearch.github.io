...
toc:
  - name: "1. The Rise of On-Device Medical Intelligence"
  - name: "2. MedGemma 1.5 4B: A Multimodal Leap"
  - name: "3. Deep Dive into the .litertlm Format"
  - name: "4. The Conversion Workflow"
  - name: "5. Model Deployment on Edge Web Browsers"
  - name: "6. Conclusion"
...
Here we are diving into how to bring state-of-the-art medical multimodal intelligence directly to the edge. By converting **MedGemma 1.5 4B** to the specialized **[LiteRT](https://github.com/google-ai-edge/LiteRT-LM)** (`.litertlm`) format, we unlock the ability to perform complex clinical analysis—including MRI interpretation and EHR questioning—entirely within a local web browser using WebGPU.
...
<video controls width="100%">
  <source src="{{ '/assets/video/medgemma_edge_demo.mp4' | relative_url }}" type="video/mp4">
...
The MedGemma 1.5 4B `.litertlm` format can be found at [https://huggingface.co/ai4med-id/medgemma-1.5-4b-it-litertlm](https://huggingface.co/ai4med-id/medgemma-1.5-4b-it-litertlm)

The code for generating the `.litertlm` model and implementing the GUI prototype: [https://github.com/AI4MedResearch/edge-ai](https://github.com/AI4MedResearch/edge-ai)
